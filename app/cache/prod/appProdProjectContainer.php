...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'locale' => 'en',
            'secret' => 'a5e24a57f10414e9ec11c4ee26b2720532375ad2',
            ...
            'kernel.secret' => 'a5e24a57f10414e9ec11c4ee26b2720532375ad2',
            ...
            'assetic.ruby.bin' => (dirname(dirname(dirname(dirname(dirname(dirname(__DIR__)))))).'/.rbenv/shims/ruby'),
            'assetic.sass.bin' => (dirname(dirname(dirname(dirname(dirname(dirname(__DIR__)))))).'/.rbenv/shims/sass'),
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'jobeet', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_497a22ccf54e49e579d1c1b1070c44a6860401ec78a0a33c23861f6c7a9d57ff');
        return $instance;
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('a5e24a57f10414e9ec11c4ee26b2720532375ad2');
    }
